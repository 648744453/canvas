...
$.ctx = $.canvas.getContext('2d');//canvas1的画笔
$.canvas2 = document.createElement('canvas');//创建一个canvas
$.canvas2.width = $.canvas.width;
$.canvas2.height = $.canvas.height;
$.ctx2 = $.canvas2.getContext('2d');//canvas2的画笔
window.addEventListener("keydown", keyDown, false);//监听键盘按下事件
window.addEventListener("keyup", keyUp, false);//监听键盘松开事件
